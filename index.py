...
def prediction():
    ...
    df = pd.read_csv("B:\DAIICT - MSc\DAIICT Tasks\Python\Fertilizer Recommendation\Fertilizer Recommendation.csv")
...
if __name__ == '__main__':
    app.run(host="localhost", port=1088, debug=True)